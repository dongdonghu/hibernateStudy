...
public class SqlCountSession implements Session{
	
	Session session;
	SQLCounter sqlCounter;
	
	public SqlCountSession(Session session, SQLCounter sqlCounter) {
		super();
		this.session = session;
		this.sqlCounter = sqlCounter;
	}

	public SQLCounter getSQLCounter(){
		return sqlCounter;
	}
	
	//below all delegated method
